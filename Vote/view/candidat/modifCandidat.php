     ...
     <div class="container">
         <div class="row">
             ...
             <div class="card">
                ...
                <div class="card-body">
                      <form action="controller/candidatController.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group mt-3">
                             ...
                             <input name="photo_parti" type="file" class="form-control" required value="<?php echo $candidat[0]['photo_parti']; ?>">
                          </div>
                          <div class="form-group mt-3">
