         ...
         <div class="row">
            ...
            //print_r($_GET);
               ...
               if(isset($_GET['etat_non_correct'])){
                  ...
                  votre compte n'est pas activer veuillez contacter la Direction !
                  </div>
                  ";
               }
               if(isset($_GET['non_correct_info'])){
                  echo "
                  <div class='alert alert-danger text-center' role='alert'>
                    veuillez verifier le informations d'authentification !
                  </div>
                  ";
               }
            ?>
               ...
               <form action="controller/electeurController.php" method="post">
                  <div class="field">
                     ...
                     <div class="control has-icons-left has-icons-right">
                        <input class="input is-success" type="text" placeholder="Entrez votre matricule" name="login" required>
                     ...
                     <div class="control has-icons-left has-icons-right">
                        <input class="input is-success" type="password" placeholder="Entrez votre mot de passe" name="mdp" required>
                        <span class="icon is-small is-left">
