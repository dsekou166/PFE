  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarScroll" >
      <ul class="navbar-nav  my-2 my-lg-0 " style="--bs-scroll-height: 100px;">
          <li><a href="?page=addvote" style="text-decoration:none;margin:5px;color:black; ">VOTER</a></li>
          <li><a href="contact/index.php" style="text-decoration:none;margin:5px;color:black; ">VOS SUGGESTION</a></li>
          <li><a href="#" style="text-decoration:none;margin:5px;color:black; ">AIDE POUR VOTE</a></li>
