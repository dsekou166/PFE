...
class  Electeur {
 ...
 public $id_bureau;
    ...
    public function __construct(
           ...
           $lieu_nais,$adress,$login,$mdp,$id_bureau)
           {
      ...
      if (!is_null($db))
       {
          ...
          adress,login,mdp,
          id_bureau
          )values(:nom_electeur,:prenom_electeur,:cni,:num_electeur,:sexe,:date_nais,:lieu_nais,:adress,:login,:mdp,:id_bureau)";
...
public static function verifieElecteur($login,$mdp) :bool
{
  $ob_connexion=new Connexion();
    ...
    //print_r($result[0]["etat"]);
      
    if ($result[0]["etat"]=="inactif"){
      
      header("location:../?page=connexion&etat_non_correct");
      die();
      //echo " votre compte n'est pas activer veuille contacter la Direction";
    }
